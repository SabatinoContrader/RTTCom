...
create table fornitore (id_product int, id_fornitore int, data_inizio date, data_fine date, prezzo_acquisto double, primary key(id_fornitore), foreign key (id_product) references product(id_product));
