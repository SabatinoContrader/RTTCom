drop table utente;
create table utente (id int auto_increment, username varchar(100),password varchar(100),nome varchar(100), cognome varchar(100), primary key(username), unique(username));
